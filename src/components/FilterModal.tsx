...
const PRICE_PRESETS = [
  { label: "Under Ksh 5M", min: null, max: 5000000 },
  { label: "Ksh 5M – 10M", min: 5000000, max: 10000000 },
  { label: "Ksh 10M – 25M", min: 10000000, max: 25000000 },
  { label: "Above Ksh 25M", min: 25000000, max: null },
];
            ...
            {[
              ...
              <View key={label} className="flex-1">
                ...
                <View
                  ...
                  style={shadow}
                >
                  <Text className="text-gray-400 text-xs mr-1 font-medium">
                    Ksh
                  </Text>
                  <TextInput
